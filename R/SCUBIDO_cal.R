...
#' between the different XRF elements and the climate data provided.
...
#' @return A list containing the results of the calibration model.
#' @export
#'
#' @import R2jags
#' @examples
#' \dontrun{
#' SCUBIDO_cal(sorted_data, plot = TRUE, summary = TRUE)
#' }
