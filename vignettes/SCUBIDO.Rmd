...
```{r model-calibration, echo=TRUE, message=FALSE, warning=FALSE, fig.width=8, fig.height=6}
calibrated_data <- SCUBIDO_cal(sorted = sorted_data, plot = T, summary = F) 
...
```{r reconstruct, echo=TRUE, message=FALSE, warning=FALSE, fig.width=8, fig.height=6}
reconstruction <- SCUBIDO_reconstruct(calibration_data = calibrated_data, plot_graph = T)
```
